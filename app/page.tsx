  ...
  return (
    <>
      <div className='container my-4'>
        <div className='flex pb-3 items-center md:justify-between flex-col md:flex-row'>
          ...
          <div className='flex flex-col items-center gap-y-2'>
            ...
            <div className='hidden md:flex gap-6'>
              ...
              <div className='flex flex-col items-center font-medium cursor-pointer'>
        ...
        <div className='flex gap-4 items-center justify-center md:justify-start'>
          <button className='text-sm text-black bg-white font-medium rounded-2xl px-4 py-2.5'>Добавить в друзья</button>
          <button className='text-sm text-black bg-white font-medium rounded-2xl px-4 py-2.5'>Написать сообщение</button>
        </div>
      </div>
    </>
  )
